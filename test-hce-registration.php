...
try {
    ...
    $uidVirtualHCE = DispositivoMovil::generarUidVirtualHCE($uuid, $credencial->uid_nfc);
    ...
    // Validación final
    $dispositivoVerificado = DispositivoMovil::where('uid_virtual_hce', $uidVirtualHCE)->first();
